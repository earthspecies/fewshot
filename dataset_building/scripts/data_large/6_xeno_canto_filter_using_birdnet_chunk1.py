...
PSEUDOVOX_MANIFEST = f'/home/davidrobinson/fewshot_data/data_medium/{dataset_name}_pseudovox.csv'
TARGET_FP = f'/home/davidrobinson/fewshot_data/data_medium/{dataset_name}_pseudovox_with_birdnet_chunk{chunk}.csv'
