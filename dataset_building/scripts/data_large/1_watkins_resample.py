...
AUDIO_FOLDER_PROCESSED = f'{DATA_BASE}/fewshot_data/data_large/watkins_resampled/'
AUDIO_FOLDER_INPUT = f'{DATA_BASE}/fewshot_data/data_large/watkins_chunks/'
...
def process_file(fp):
    ...
    try:
        ...
        # x = x[:max_file_dur_samples] don't truncated
...
files = [os.path.join(AUDIO_FOLDER_INPUT, f) for f in os.listdir(AUDIO_FOLDER_INPUT) if f.endswith('.wav')]
