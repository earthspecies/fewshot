...
base_dir = f"{DATA_BASE}/fewshot_data/data_large/"
dataset_name = "animalspeak"

input_dirs = [f"{dataset_name}_pseudovox", f"{dataset_name}_audio_trimmed"]
output_dirs = [f"{dataset_name}_pseudovox_48k", f"{dataset_name}_audio_trimmed_48k"]
...
def resample_file(input_file, output_file, target_sr=48000):
    try:
        # Load audio file
