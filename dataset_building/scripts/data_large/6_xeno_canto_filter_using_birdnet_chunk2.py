...
PSEUDOVOX_MANIFEST = f'/home/jupyter/data/fewshot_data/data_large/{dataset_name}_pseudovox.csv'
TARGET_FP = f'/home/jupyter/data/fewshot_data/data_large/{dataset_name}_pseudovox_with_birdnet_chunk{chunk}.csv'
