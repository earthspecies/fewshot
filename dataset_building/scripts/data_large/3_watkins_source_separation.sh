mixit_path="/home/ubuntu/foundation-model-storage/sound-separation/"
info_path="/home/ubuntu/fewshot_data/data_large/watkins_temp_mixit_manifest.csv"

cd ${mixit_path}
python3 ${mixit_path}models/tools/process_wav_stitching_batched_opt.py \
