...
dataset_names = ["PW"] #[x+"_crossfile" for x in ["katydid", "marmoset", "Spiders"]] #, "PB", "PB24"]
...
# # DOUBLETIME!!
# dataset_names = ["HB", "PW", "RD"]
# parent_dir = "/home/jupyter/data/fewshot_data/evaluation/formatted"

# for dataset in dataset_names:
#     print(f"Processing {dataset}")
#     dataset_dir = os.path.join(parent_dir, dataset)
#     new_dataset_dir = os.path.join(parent_dir, dataset+"_doubletime")
...
# dataset_names = ["katydid_crossfile"]
# parent_dir = "/home/jupyter/data/fewshot_data/evaluation/formatted"
