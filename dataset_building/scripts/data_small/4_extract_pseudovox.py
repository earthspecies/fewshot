...
#         if m[i] and not m[i-1]:
#             look_forward = m[i:i+min_pos]
#             if not np.all(look_forward):
#                 m[i] = False
...
raw_dir = '/home/jupyter/fewshot/data/data_small/audio_trimmed'
stems_dir = '/home/jupyter/fewshot/data/data_small/audio_mixit'
output_dir = '/home/jupyter/fewshot/data/data_small/pseudovox'
...
info_df.to_csv(os.path.join(data_dir, "pseudovox.csv"), index=False)