...
AUDIO_FOLDER_RAW = '/home/jupyter/data/fewshot_data/data_medium/TUT_audio/'
AUDIO_FOLDER_PROCESSED = '/home/jupyter/data/fewshot_data/data_medium/TUT_audio_trimmed/'

if not os.path.exists(AUDIO_FOLDER_PROCESSED):
    os.makedirs(AUDIO_FOLDER_PROCESSED)

assumed_orig_sr=44100
